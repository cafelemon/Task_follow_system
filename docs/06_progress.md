...
当前状态：4.3.0 已完成执行者工作台与待归类事项 4.3.x 分版本规划；本版不新增业务功能、不新增数据库结构、不制作生产离线包。
...
- 明确所有人都可在工作台提交待归类事项，首版只填写事项内容和责任人，不要求员工判断任务层级。
...
- 明确 4.3.x 只做执行者侧闭环：工作台、本人任务、待归类事项提交、事项状态查看和个人周报材料雏形。
- 拆分 4.3.1 至 4.3.4：执行者工作台框架、待归类事项提交入口、执行者个人周报材料雏形、执行者体验收尾与 4.4 准备。
