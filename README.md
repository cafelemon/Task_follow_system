...
公司任务跟踪系统是面向公司级任务推进、每周更新、风险协调和会议看板的独立 Web 系统。3.0.0 是生产第一版；当前 4.4.3 已完成本部门常态化事项处理视图。本版不制作生产离线包。
...
- 4.4.3 已开放本部门常态化事项处理视图：部门负责人可查看本部门常态化记录并处理待确认事项，已确认内容进入提交人周报材料但不进入正式任务树和进度统计。跨部门双确认、缺任务诉求上提、通知恢复和生产包仍不在本版范围。
