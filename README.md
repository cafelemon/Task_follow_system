...
公司任务跟踪系统是面向公司级任务推进、每周更新、风险协调和会议看板的独立 Web 系统。3.0.0 是生产第一版；当前 4.3.6 已完成执行者侧工作台、待归类事项和周报中心收尾。本版不制作生产离线包。
...
- 4.3.6 已完成执行者侧收尾：工作台、待归类事项和周报中心文案及移动端体验进一步收敛；4.4.0 将进入任务负责人/责任人处理线。本版不做导出文档、飞书汇报回写、通知或责任人处理。
