...
公司任务跟踪系统是面向公司级任务推进、每周更新、风险协调和会议看板的独立 Web 系统。3.0.0 是生产第一版；当前 4.2.0 在 4.1.0 部门管理基础上完成飞书汇报集成可行性与任务治理方案验证，不新增业务功能、不新增数据库结构、不制作生产离线包。
...
- 4.2.0 已明确飞书汇报边界：系统内生成个人周报可行，飞书原生汇报自动提交暂不承诺；临时/日常工作后续按“待归类事项”治理，不建设长期游离于任务树外的日常任务池。
