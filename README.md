...
公司任务跟踪系统是面向公司级任务推进、每周更新、风险协调和会议看板的独立 Web 系统。3.0.0 是生产第一版；当前 4.5.0 已完成部门负责人和总经办会议工作台分版本规划。本版只做规划和文档同步，不制作生产离线包。
...
- 4.5.0 已规划部门负责人和总经办会议工作台深化：4.5.x 将围绕缺部门任务诉求、缺母任务诉求、风险逾期、未更新和会议处理顺序分步推进；本规划版不改业务代码、不新增数据库结构、不恢复通知、不制作生产包。
