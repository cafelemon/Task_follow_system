...
公司任务跟踪系统是面向公司级任务推进、每周更新、风险协调和会议看板的独立 Web 系统。3.0.0 是生产第一版；当前 4.3.0 完成执行者工作台与待归类事项 4.3.x 分版本规划，不新增业务功能、不新增数据库结构、不制作生产离线包。
...
- 4.3.0 已明确执行者侧分步落地计划：4.3.1 工作台框架，4.3.2 待归类事项提交，4.3.3 本周材料雏形，4.3.4 执行者体验收尾与 4.4 准备。
